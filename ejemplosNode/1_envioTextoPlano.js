...
const requestHandler = ( peticion, respuesta ) => {
  ...
  //En lugar de text-plain también valdría text/html
  respuesta.write( 'Hello Node.js Server!' );
  console.log( peticion.url ); //atributo url del objeto http: consolea--> /
  respuesta.end();
}
/*Con el objeto de respuesta (parámetro), nos podremos comunicar con el client y, lo primero que haremos, será mandar la cabecera HTTP con una confirmación correcta (200) y con el tipo de contenido que vamos a mandar*/
